...
namespace UnityEditor
{
    ...
    internal class IsometricRuleTileEditor : RuleTileEditor
    {
        ...
        internal override void RuleMatrixOnGUI(RuleTile ruleTile, Rect rect, Rect rect1, RuleTile.TilingRule tilingRule)
        {
            ...
            for (int y = 0; y <= 2; y++)
            {
                for (int x = 0; x <= 2; x++)
                {
                    ...
                    if (x != 1 || y != 1)
                    {
                        ...
                        RuleNeighborUpdate(r, r, tilingRule, index);
                    ...
                    else
                    {
                        ...
                        RuleTransformUpdate(r, r, tilingRule);
                    }
                }
            }
        }
