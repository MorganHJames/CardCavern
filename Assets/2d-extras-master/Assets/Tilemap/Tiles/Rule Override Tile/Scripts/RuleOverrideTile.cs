    ...
    public class RuleOverrideTile : TileBase
    {
        ...
        public RuleTile.TilingRule this[RuleTile.TilingRule originalRule]
        {
            ...
            set
            {
                ...
                else
                {
					...
					m_OverrideTilingRules[index].m_TilingRule.m_SiblingNeighbors = null;
				}
            }
        }
        ...
        public void CopyTilingRule(RuleTile.TilingRule from, RuleTile.TilingRule to, bool copyRule)
        {
            if (copyRule)
            {
				...
				to.m_SiblingNeighbors = from.m_SiblingNeighbors;
            }
			...
			to.m_CheckSiblings = from.m_CheckSiblings;
			to.m_SiblingTile = from.m_SiblingTile;
