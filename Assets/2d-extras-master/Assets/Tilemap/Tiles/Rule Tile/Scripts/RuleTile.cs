...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
		...
		public virtual Type m_SiblingNeighborType { get { return typeof(TilingRule.Neighbor); } }
		...
		public bool m_DefaultCheckSiblings = false;
		public GameObject m_DefaultGameObject;
		public Tile m_DefaultTileToCheckAgainst;
        ...
        public class TilingRule
        {
			...
			public int[] m_SiblingNeighbors;
			public Sprite[] m_Sprites;
            public GameObject m_GameObject;
			public TileBase m_SiblingTile;
        ...
        public virtual bool RuleMatch(int neighbor, TileBase tileToCheck, TileBase tileToAgainst)
        {
            switch (neighbor)
            {
                case TilingRule.Neighbor.This: return tileToCheck == tileToAgainst;
                case TilingRule.Neighbor.NotThis: return tileToCheck != tileToAgainst;
            }
            return true;
        }
        ...
        protected bool RuleMatches(TilingRule rule, ref TileBase[] neighboringTiles, int angle)
        {
            for (int i = 0; i < neighborCount; ++i)
            {
				...
				if (!RuleMatch(rule.m_Neighbors[i], tile, m_Self))
					return false;

				if (rule.m_CheckSiblings)
					if (!RuleMatch(rule.m_SiblingNeighbors[i], tile, rule.m_SiblingTile))
						return false;
			}
            return true;
        }
